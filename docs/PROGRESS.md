...
| C | Write binding (decision 9) - writes follow reads on every client-supplied entry id | todo, planned: [2026-09-11-authz-phase-c-write-binding.md](superpowers/plans/2026-09-11-authz-phase-c-write-binding.md) |
