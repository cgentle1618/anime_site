          ...
          <table className="w-full text-left">
            <thead className="bg-gray-50 border-b border-gray-200 sticky top-0 z-10">
              <tr>
                ...
                <th className="px-4 py-3 text-xs font-black text-gray-500 uppercase tracking-wider text-center border-r border-gray-100 hidden sm:table-cell">
                  EP
                </th>
                <th className="px-4 py-3 text-xs font-black text-gray-500 uppercase tracking-wider text-center border-r border-gray-100 hidden lg:table-cell">
                  My
            ...
            <tbody className="divide-y divide-gray-100">
              {filteredAndSorted.map((a) => {
                ...
                const cumTotal =
                  a.cum_ep_total ??
                  (a.ep_total !== null && a.ep_total !== undefined
                    ? a.ep_total
                    : "?");
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-2 text-xs text-center font-bold text-gray-600 border-r border-gray-100 hidden md:table-cell">
                      {a.airing_type || "-"}
                    </td>
                    <td className="px-4 py-2 text-xs text-center text-gray-500 border-r border-gray-100 hidden lg:table-cell">
                      {a.season_part || "-"}
                    </td>
                    ...
                    <td className="px-4 py-2 text-xs text-center font-mono text-gray-700 border-r border-gray-100 hidden sm:table-cell">
                      {cumFin} / {cumTotal}
                    </td>
